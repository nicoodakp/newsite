$(document).ready(function getWeather() {
  ...
  function error() {
    ...
    if (alerted != 'yes') {
     alert("Sorry, I don't know where you are, abort weather service.");
  ...
  function getWeatherData(latitude, longitude) {
    var weatherapiurl = "https://api.forecast.io/forecast/693bfc720a2fc19b10c0d12926307eb7/"+latitude+","+longitude+"?callback=?"
    $.getJSON(weatherapiurl, function(weatherdata) {
      ...
      $("#day2-high-low").html(Math.round(tempMaxArray[0]) + "/" + Math.round(tempMinArray[0])+"°");
      $("#day3-high-low").html(Math.round(tempMaxArray[1]) + "/" + Math.round(tempMinArray[1])+"°");
      $("#day4-high-low").html(Math.round(tempMaxArray[2]) + "/" + Math.round(tempMinArray[2])+"°");
